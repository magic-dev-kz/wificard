...
- **Performance: deferred non-critical init**: SW registration wrapped in `requestIdleCallback` (with `setTimeout` fallback) so main UI renders before secondary features load
- SW cache bumped to `wificard-v26.0`
...
- SW cache bumped to `wificard-v25.0`
...
- SW cache bumped to `wificard-v24.0`
...
- SW cache bumped to `wificard-v18.0`
